...
export default function ChildCareImages() {
  const [images, setImages] = useState<ChildCareImage[]>([]);
  const [loading, setLoading] = useState(false);
  const [uploading, setUploading] = useState(false);
  const [selectedSection, setSelectedSection] = useState("classroom");
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Child Care Images</h1>
          <p className="text-muted-foreground">
            Manage images displayed on the child care page
          </p>
        </div>
            ...
            <div className="space-y-4">
              {images.map((image) => (
                ...
                >
                  <img
                    src={image.image_url}
                    alt={image.title || "Child care image"}
